...
CUDA_VISIBLE_DEVICES=0 python render/render_jsbsim.py \
    ...
    --num-mini-batch 5 --buffer-size 3000 --num-env-steps 1e8 --alpha-0 1\
    ...
    --user-name "jyh" --use-prior \
    --model-dir './results/SingleCombat/1v1/ShootMissile/HierarchySelfplay/ppo/v1/run1'
